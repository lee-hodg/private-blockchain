...
class Blockchain {
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            let timeElapsedSeconds = currentTime - messageTime;
            const fiveMinutes = 300;
            if (timeElapsedSeconds > fiveMinutes){
                reject(new Error('Message has expired!'));
            }
            ...
            if(bitcoinMessage.verify(message, address, signature)){
                ...
                reject(new Error('Could not verify message!'));
            }
    ...
    getBlockByHeight(height) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if(block){
                ...
                resolve(new Error(`Found no hash matching ${hash} on the chain.`));
            }
        });
    }
